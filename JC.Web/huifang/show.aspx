<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="show.aspx.cs" Inherits="JC.Web.huifang.show" %>
    ...
    <div class="user-case">
        <div class="crumbs fix" style="margin-bottom: 40px;">
            <div class="crumbs-box">
                <a href="/">首页</a> > <a href="/<%=tbs %>/">用户回访</a> > <span><%=mpost.title %></span>
            </div>
        ...
        <div class="case-details">
            <div class="title fix">
                ...
                <div class="share vm" style="display: inline-block;">
                    ...
                    <script>window._bd_share_config = {"common": { "bdSnsKey": {}, "bdText": "<%=mpost.title %>", "bdMini": "2", "bdMiniList": false, "bdPic": "<%=msite.url + mpost.pic %>", "bdStyle": "1", "bdSize": "16" },"share": {},"image": { "viewList": ["qzone", "tsina", "tqq", "renren", "weixin"], "viewText": "分享到：", "viewSize": "16" },"selectShare": { "bdContainerClass": null, "bdSelectMiniList": ["qzone", "tsina", "tqq", "renren", "weixin"] }}; with (document) 0[(getElementsByTagName('head')[0] || body).appendChild(createElement('script')).src = 'http://bdimg.share.baidu.com/static/api/js/share.js?v=89860593.js?cdnversion=' + ~(-new Date() / 36e5)];</script>
                </div>
                <a href="/<%=tbs %>/" class="go-back"><img src="/content/dist/img/h39.png" class="vm" />返回上页</a>
            </div>
