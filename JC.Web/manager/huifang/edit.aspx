<%@ Page  Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="JC.Web.manager.huifang.edit" %>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal" method="post" runat="server">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description" placeholder="简述"   class="form-control"><%=post.description %></textarea>
                                </div>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group date ">
                                        ...
                                        <input type="text" readonly name="ext1"  value="<%=post.ext1??DateTime.Now.ToString("yyyy-MM-dd") %>" placeholder="安装日期"  id="txtExt1" class="form-control datepicker pull-right">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"  >使用费用</label>
                                <div class="col-sm-10">
                                    <input type="text" name="ext2" value="<%=post.ext2 %>" placeholder="使用费用：2015年冬天平均800元/月"  class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"  >房型</label>
                                <div class="col-sm-10">
                                    <input type="text" name="ext3" value="<%=post.ext3 %>" placeholder="房型：三室两厅"  class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"  >建筑面积</label>
                                <div class="col-sm-10">
                                    <input type="text" name="ext4" value="<%=post.ext4 %>" placeholder="建筑面积：123平米"   class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"  >安装面积</label>
                                <div class="col-sm-10">
                                    <input type="text" name="ext5" value="<%=post.ext5 %>" placeholder="安装面积：56平方米（卧室、客厅）"   class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label"  >产品类型</label>
                                <div class="col-sm-10">
                                    <input type="text" name="ext6" value="<%=post.ext6 %>" placeholder="产品类型：实木多层系列 瓷砖系列"   class="form-control" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-2 control-label" >客户简评</label>
                                <div class="col-sm-10">
                                    <input type="text" name="ext7" value="<%=post.ext7 %>" placeholder="客户简评"   class="form-control" />
                                </div>
                            </div>
                             ...
                             <div class="form-group" style="<%=msite.lang.Split(',').Contains("英文")?"": "display:none;" %>">
                                <label class="col-sm-2 control-label" for="txtTitleen">标题英文</label>
                                <div class="col-sm-10">
                                    <input type="text" name="titleen" placeholder="标题英文" id="txtTitleen" class="form-control" value="<%=post.titleen %>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="<%=msite.lang.Split(',').Contains("英文")?"": "display:none;" %>">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="descriptionen"  placeholder="简述英文"  class="form-control" value="<%=post.descriptionen %>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="txtPic">封面图片</label>
                                <div class="col-sm-10">
                             ...
                             <div class="form-group">
                                <label class="col-sm-2 control-label" for="txtPic">子图片（可传<%=msite.picmaxlength %>张）</label>
                                <div class="col-sm-10">
                                    ...
                                    <div class="imgpreview-wrap">
                                        <i class="fa-my-controlbar fa fa-close "></i>
                                        <img src="<%=plist[i] %>" class='imgpreview' style="width: 35px; height: 35px;" alt="" onclick="BrowseServer('Images:/', 'txtPicList<%=i+1 %>');" />
