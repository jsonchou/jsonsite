<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="JC.Web.manager.qa.index" %>
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="j_table" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th ><label><input type="checkbox" id="j_ckAll" name="ckAll" value="" />全选</label></th>
                                            <th>ID</th>
                                            <th>咨询内容</th>
                                            <th>回答内容</th>
                                            <th>有效</th>
