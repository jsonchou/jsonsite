<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="JC.Web.manager.users.index" %>
                ...
                <div class="box box-site">
                    ...
                    <form class="form-horizontal" method="post" runat="server">
                        ...
                        <div class="box-footer text-right">
                            <input type="button" value="删除用户" class="btn btn-info" id="j_delIDlist" />
                            <a href="/manager/<%=mymodule %>/edit" class="btn btn-info">添加用户</a>
                        </div>
                        <!-- /.box-footer -->
            ...
            myDataTable = $('#j_table').DataTable({
               ...
               { "data": "email" },
               {
               ...
               },
                {
                    "data": "isadmin",
                    render: function (data, type, row) {
                        return "<span data-flag='isadmin'  data-id='" + row.id + "'   data-flagcn='管理员'  data-v='" + data + "'  class='fa-my-controlbar fa fa-" + (data == 1 ? "check" : "close") + "  '></span>";
                    }
                },
                 { "data": "logtime" },
               {
               ...
               {
                   "data": "modifydate", render: function (data, type, row) {
                       return moment(data).format('YYYY-MM-DD');
                   }
               },
              {
                ...
                "drawCallback": function (settings) {
                    gImgPreview();
                    gInputCheckAll();
                    gTableAjaxControl(mytb, function () {
                        _uzw.cookie.del("gUzaiManagerMenu-EndTime");
                    });
                }
            });
