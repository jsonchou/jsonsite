<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="JC.Web.manager.news.index" %>
                    ...
                    <form class="form-horizontal" method="post" runat="server">
                        ...
                        <div class="box">
                            ...
                            <div class="box-footer text-right">
                                <input type="button" value="删除新闻" class="btn btn-info" id="j_delIDlist" />
                                <a href="/manager/<%=mymodule %>/edit" class="btn btn-info">添加新闻</a>
                            </div>
