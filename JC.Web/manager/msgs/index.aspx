<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="JC.Web.manager.msgs.index" %>
                    ...
                    <form class="form-horizontal" method="post" runat="server">
                        ...
                        <div class="box">
                            ...
                            <div class="box-footer text-right">
                                <input type="button" value="删除留言" class="btn btn-info" id="j_delIDlist" />
                                <a href="/manager/<%=mymodule %>/edit" class="btn btn-info">添加留言</a>
                            </div>
        ...
        $(function () {
            ...
            myDataTable = $('#j_table').DataTable({
                ...
                },
                {
                    "data": "read",
                    render: function (data, type, row) {
                        return "<span data-flag='read'  data-id='" + row.id + "'   data-flagcn='已读'  data-v='" + data + "'  class='fa-my-controlbar fa fa-" + (data == 1 ? "check" : "close") + "  '></span>";
                    }
                }, {
                    "data": "control",
                    render: function (data, type, row) {
