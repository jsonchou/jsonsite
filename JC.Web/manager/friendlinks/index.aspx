<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="JC.Web.manager.friendlinks.index" %>
                    ...
                    <form class="form-horizontal" method="post" runat="server">
                        ...
                        <div class="box">
                            ...
                            <div class="box-footer text-right">
                                <input type="button" value="删除友情链接" class="btn btn-info" id="j_delIDlist" />
                                <a href="/manager/<%=mymodule %>/edit" class="btn btn-info">添加友情链接</a>
                            </div>
    ...
    <script>
        ...
        $(function () {
            ...
            myDataTable = $('#j_table').DataTable({
               ...
               { "data": "keywords" },
               {
                   "data": "ext1", render: function (data, type, row) {
