...
namespace JC.Web.manager.cases
{
    public partial class edit : App_Code.PageBase
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            //扩展信息
            post.ext1= Request.Form["ext1"];//房型
            post.ext2 = Request.Form["ext2"];//建筑面积
            post.ext3 = Request.Form["ext3"];//安装面积
            post.ext4 = Request.Form["ext4"];//产品类型
