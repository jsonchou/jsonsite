<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="edit.aspx.cs" Inherits="JC.Web.manager.modules.edit" %>
                    ...
                    <form class="form-horizontal" method="post" runat="server">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <label>
                                        <input type="checkbox" name="ckBlank" <%=(module.blank==1)?"checked":"" %> />
                                        新窗口打开</label>
                                    <input type="hidden" name="ckBlankHid" id="ckBlankHid" value="<%=module.blank %>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <select name="select-sub-0" data-parentid="0" class="form-control" <%= !string.IsNullOrEmpty(myid)?"disabled":"" %> >
                                        <option value="-1">请选择</option>
                                        <%
                                            var unitModelSingle = singleModules(0);
                                ...
                                { %>
                                         ...
                                         <% var unitModel = singleModules(int.Parse(arr[m]));%>
                                        <%if(unitModel.Count>0) {%>
                                        <div class="col-sm-2">
                                        <select name="select-sub-<%=arr[m] %>" data-parentid="<%=arr[m] %>" class="form-control" <%= !string.IsNullOrEmpty(myid)?"disabled":"" %> >
                                        <option value="-1">请选择</option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="url" placeholder="链接地址" class="form-control" value="<%=module.url %>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="title" placeholder="标题" class="form-control" value="<%=module.title %>" />
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="content" placeholder="内容" class="form-control"><%=module.content %></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="imgpreview-wrap">
                                        ...
                                        <img src="<%=module.pic %>" class='imgpreview' style="width: 35px; height: 35px;" alt="" onclick="BrowseServer('Images:/', 'txtPic');" />
                                        <input type="hidden" value="<%=module.pic %>" name="pic" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="orderby" value="<%=module.orderby %>" placeholder="邮箱" class="form-control">
                                </div>
                            </div>
